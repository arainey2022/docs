...
description: "Getting started with our API is quick and easy. With the My AskAI API you can ask questions to your My AskAI to build your apps or workflows."
---
...
[For details on how to use the Query API click here.](/api-documentation/query-api)
