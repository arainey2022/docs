---
title: "Onboarding"
description: "Pretty much the first question everyone has before signing up to My AskAI, is \"how long will this take to set up?\", so let me explain what our onboarding looks like."
---
...
You'll only need to get a developer involved if/when you start wanting to connect [User Data](/features/user-data-api) or set up [Tools](/features/ai-actions-tools) for your AI agent.
...
Once you sign up, you will [go through a simple onboarding set-up](/start-here/create-your-ai-customer-service-agent) where you'll:

* [Connect](/features/connections) your existing help center, store or website (one-click connection or enter a URL)
* Configure any [guidance](/features/improve/guidance) you want to use (or leave as is and update later)
...
* Add [guidance](/features/improve/guidance) to match your company's tone of voice/brand guidelines
* Set up AI auto-tagging (where available)&#x20;
* [Invite team members](/features/team-access) to Dashboard and define roles

#### Day 2-7 (15-30 mins/day)

* Review AI agent replies and responses (in helpdesk and in My AskAI [Inspect & Logs](/features/improve/inspect-and-logs)):
  * Identify obvious knowledge gaps, update articles or add [custom answers](/features/improve/custom-answers)
  * Update guidance for tone, scenario-based rules
  * Identify areas where [User Data](/features/user-data-api), [Tools](/features/ai-actions-tools) or [Tasks](/features/tasks) may have an impact
  * Review tag categories you don't want to use AI for
* Get a benchmark "AI resolution" rate for the AI agent
* Get all agents to Install [Chrome Extension copilot](/features/channels/chrome-extension)

#### Day 8-14 (15 mins/day)

* Start to see the [Self-learning](/features/self-learning) articles that are being generated for you
...
* Review [Insights](/features/insights) and sort by lower AI resolution and CSAT topics to identify areas for improvement
* Review a sample of AI agent replies and responses (in helpdesk and in My AskAI [Inspect & Logs](/features/improve/inspect-and-logs)):
  * Identify obvious knowledge gaps, update articles or add [custom answers](/features/improve/custom-answers)
  * Update guidance for tone, scenario-based rules
  * Identify areas where [User Data](/features/user-data-api), [Tools](/features/ai-actions-tools) or [Tasks](/features/tasks) may have an impact
* Create multi-step [Tasks](/features/tasks) (excluding tools) for highest impact processes
...
* Daily/weekly QA review of a sample of AI agent replies
  * Review and approve [Self-learning](/features/self-learning) updates
  * Tweak guidance
...
* Create APIs to allow AI agent to interact with back-end databases via [Tools](/features/ai-actions-tools)
* Create multi-step [Tasks](/features/tasks) (including tools) for highest impact processes

### How do I test my AI agent's responses?

For more on testing your AI agent's responses, read [Testing](/features/testing).
