...
description: "An AI support agent is an AI, question-answering, customer support agent trained on your businesses' content, like your help docs."
---
...
If the AI can't answer the question, or if at any time the customer wants to speak to a person, they can too by using our [human handover](/features/human-escalation) feature.
...
<Card title="Create your AI customer service agent" href="/start-here/create-your-ai-customer-service-agent" horizontal />
