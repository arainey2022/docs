...
1. In your My AskAI Dashboard and go to _Channels \> Freshdesk logo_
2. Select ‘Freshdesk Tickets’
3. Enter your Freshdesk domain (your domain is within the URL of your Freskdesk inbox. [e.g.myaskai.freshdesk.com](http://e.g.myaskai.freshdesk.com)) and your API key and click ‘Connect your Freshdesk account’.
...
4. Once connected it'll change to say "Freshdesk account connected".
5. Once back at My AskAI, you can choose how you want your AI agent to reply, by default it will create [Internal Note](/features/channels/freshdesk#internal-notes) responses, but you can also enable [Direct replies](/features/channels/freshdesk#direct-replies).

6. You will now be generating AI replies to your tickets, test it out by emailing your Freshdesk inbox.
