---
title: "Freshchat"
description: "Connect your AI support agent to your Freshchat workspace and existing Freshchat live chat widget (Conversations Widget) on your website."
---
...
- You can add more knowledge to your AI agent in addition to your website and Freshdesk help center by using our [connections](/features/connections), live data or [file uploads](/features/file-uploads).
- You don't have to add any code to your site to get your AI agent live, just connect our app and you're ready to go.
- As well as an AI agent, you get all our other features like [Improve,](/features/improve) [Insights](/features/insights), [Email Assistant](/features/email-assistant), [Site Search](/features/site-search), [Private (Internal) mode](/features/private-internal-mode), [Integrations with Slack](/features/channels) and more. 
...
<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/m1YPYZcB8Jw" title="Embedded video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
</Frame>
...
2. Once enabled you will see "Add to helpdesk", click on the Freshworks icon and select Freshchat.
3. To connect your Freshchat account enter your API key and Chat URL. To find these in your Freshchat dashboard go to:\
   \
   **_Admin Settings \> Marketplace and Integrations \> API Settings \> API details for chat \> "Your API key" OR "Your chat URL"_**\
   \
...
5. You now need to create a new webhook, to do this in your Freshchat dashboard go to:\
   \
   **_Admin Settings \> Marketplace and Integrations \> Conversation Webhooks_**\
   \
   Then toggle the webhook from Disabled to **Enabled.**

<Frame>
  ![](/images/screenshot-2024-12-12-153818.png)
</Frame>
...
<Frame>
  ![](/images/screenshot-2024-12-13-141002.png)
</Frame>
...
8. Your AI agent is now connected to Freshchat and will be [providing "note" responses](/features/channels/freshchat#how-to-draft-ai-conversational-replies-to-users-without-sending-them) (not directly to customers).

### How can I use my AI support agent within Freshchat?

There are 3 ways you can use your AI agent within Freshchat:

1. _[As a full conversational AI agent](/features/channels/freshchat#how-to-set-up-an-ai-powered-chatbot-within-intercom-fully-conversational-support)._
2. [To provide "Note" replies to all messages.](/features/channels/freshchat#how-to-draft-ai-conversational-replies-to-users-without-sending-them-in-freshchat)
3. _[As a co-pilot for your human agents to help them improve their efficiency](/features/channels/chrome-extension)._

### How to set up an AI-powered support agent within Freshchat (Fully conversational support)

1. [Connect your AI agent to Freshchat](/features/channels/freshchat#how-to-connect-your-ai-chatbot-to-intercom)
2. Toggle conversational replies "on" by going to your Dashboard then **_Channels \> Add to helpdesk \> Freshworks \> Freshchat_** clicking the "Direct replies" button.
...
1. [Connect your AI support agent to Freshchat](/features/channels/freshchat#how-to-connect-your-ai-chatbot-to-intercom)
2. Toggle note replies "on" by going to your Dashboard then **_Channels \> Add to helpdesk \> Freshworks \> Freshchat_** clicking the "Draft 'note' replies" toggle.
...
<Frame>
  <img
    src="/images/image-1-1-1-1-1-1-1-1-1.png"
    width="563"
  />
</Frame>
...
<Frame>
  <img
    src="/images/image-2-1-1-1-1.png"
    width="563"
  />
</Frame>
...
4. Your new AI Chat Status will always be **one** of:
   ...
   - `human-handover-requested`: used when the AI agent wants to escalate a chat to a human agent
...
Additionally ([if you have created your AI Chat Status for Freshchat](/features/channels/freshchat#how-do-i-add-conversation-properties-so-i-know-what-the-ai-chat-status-of-a-freshchat-conversation-i)) you will see the AI Chat Status tag updated to `ai-agent-replied`  for the thread.

When a conversation is replied to by a customer requesting a person (if they need more help for instance) then an internal note is also added to the ticket and ([if you have created your AI Chat Status for Freshchat](/features/channels/freshchat#how-do-i-add-conversation-properties-so-i-know-what-the-ai-chat-status-of-a-freshchat-conversation-i)) the AI Chat Status is updated to `human-handover-requested`.

Assuming you have [created your AI Chat Status](/features/channels/freshchat#how-do-i-add-conversation-properties-so-i-know-what-the-ai-chat-status-of-a-freshchat-conversation-i) you can then use the `ai-agent-replied` and `human-handover-requested` conversation properties to create custom views in Freshchat to manage the escalated tickets or review AI agent responses.
...
1. [Connect your agent to Freshchat](/features/channels/freshchat#how-to-connect-your-ai-chatbot-to-intercom)
2. Turn on the toggle switch for Chatbot/Triage settings
3. Decide on a trigger phrase to use for your AI chatbot escalate button, type it into the field below the toggle switch and include this as the text in a button in your chatbot (example chatbot flow below for "Speak to AI" as the trigger phrase).

<Danger>
  This phrase must **_exactly_** match the pre-defined button you are going to use in your chatbot message.
</Danger>
...
But if you want it to reply to only certain email addresses e.g. [support@company.com](mailto:support@company.com) and not [vip-support@company.com](mailto:vip-support@company.com) then you can use workflows to triage tickets.
...
To stop your AI agent from replying to specific topics in Freshchat you can use our [Block replies feature within Freshchat tagging](/features/channels/freshchat/freshchat-tagging).
...
1. Going to **Channels \> Add to helpdesk \> Freshworks** and click on the Freshchat icon
...
You can prevent "instant" human escalation on the 1st message in a conversation on Freshchat by navigating to **Channels \> Add to helpdesk \> Freshworks \> Freshchat** and then toggling the "_Prevent immediate escalation_" feature.
...
To do this, [follow our guide on escalation data collection here](/features/escalation-data-collection).
...
It will retain all the [same features of the Freshchat agent](/features/channels/freshchat#how-can-i-use-my-ai-chatbot-within-intercom), including human escalation, but within the respective platforms.
...
Just go to **Channels \> Add to helpdesk \> Freshworks \> Freshchat** and toggle the "Hide the "just thinking" message to off.

### How can I pause or temporarily turn off AI replies or notes in Freshchat?

To pause or temporarily pause AI replies or notes in Freshchat go to **Channels \> Add to helpdesk \> Freshworks \> Freshchat** then scroll to the toggle for "Pause AI agent".
