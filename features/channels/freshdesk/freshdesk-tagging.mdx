---
title: "Freshdesk (Tagging)"
description: "Automatically tag your tickets and emails in Freshdesk with custom tags and sentiment scores."
---
...
1. To set up your tags in Freshdesk, go to **AI Agent Setup \> AI Tagging** and click **Import tag or custom field.**
...
4. You will then see your tags auto-applied in Freshdesk, additionally the tag `ai-agent-tags-applied` will be applied so you know when it has been used.<br />If you feel any tags have been applied incorrectly, review the description for each tag to ensure it is clear.
...
To add a tag to your block list, go to **AI Agent Setup \> AI Tagging**, select the Custom Field or Tag that has the tag you want to block, then find the tag and click **Block.**
