---
title: "Zendesk (Tagging)"
description: "Automatically tag your tickets and conversations in Zendesk with custom tags and sentiment scores."
---
...
5. You will then see your tags auto-applied in Zendesk, additionally the tag `ai-agent-tags-applied` will be applied so you know when it has been used.<br />If you feel any tags have been applied incorrectly, review the description for each tag to ensure it is clear.
...
<Frame>
  <img
    src="/images/screenshot-2025-01-23-at-15-19-26.png"
    alt=""
    width="563"
  />
</Frame>
