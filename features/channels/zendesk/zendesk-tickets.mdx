...
<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/lnxOWzyiEKw" title="Embedded video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
</Frame>
...
<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/gPhN5wP-ZtY" title="Embedded video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
</Frame>
...
<Frame>
  <img
    src="/images/image-69-1.png"
    width="563"
  />
</Frame>

2. Create a new trigger to assign AI agent-handled tickets to AI Agent status<br /><br />Trigger name: Assign AI Agent Ticket<br /><br />Tag values: `ai-agent-replied` & `human-handover-requested`

<Frame>
  <img
    src="/images/image-70-1.png"
    width="563"
  />
</Frame>

3. Create a new trigger to assign escalation tickets back to Open status<br /><br />Trigger name: Assign AI Handover Ticket<br /><br />Tag value: `human-handover-requested`

<Frame>
  <img
    src="/images/image-71-1.png"
    width="563"
  />
</Frame>

4. Create a new view for agents to see AI Agent assigned tickets<br /><br />These triggers (or order of triggers) may need to be adjusted to match your organisation's workflows and avoid any conflicts.

<Frame>
  <img
    src="/images/image-72-1.png"
    width="563"
  />
</Frame>
...
<Frame>
  <img
    src="/images/image-73-2.png"
    width="563"
  />
</Frame>

### How can I auto-close a ticket in Zendesk Tickets?
...
But if you want it to reply to only certain email addresses or brands e.g. [support@company.com](mailto:support@company.com) and not [vip-support@company.com](mailto:vip-support@company.com)  then you can edit the Trigger conditions and add the brands or email accounts you want it to reply to (e.g. [support@company.com](mailto:support@company.com)). 
