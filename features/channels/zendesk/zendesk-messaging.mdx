...
<Card title="myaskai.com/blog/customerio-myaskai-case-study" href="https://myaskai.com/blog/customerio-myaskai-case-study" icon="arrow-up-right-from-square" />
...
<Frame><img src="/images/image-367.png" alt="" width="453"  /></Frame>

6. Allow access to your Zendesk account

<Frame><img src="/images/image-520.png" alt="" width="375"  /></Frame>
...
<Frame><img src="/images/image-521.png" alt="" width="563"  /></Frame>
...
10. After tickets have been 'Solved' they need to be moved to 'Closed', so that the AI agent can take control of the conversation again. There are two ways you can do this.
    1.  Go to _**Objects and rules > Automations**_, and find the existing automation called "Close ticket 4 days". Edit the "Hours since status..." field to 1 (recommended, but you can choose your own value). This means after tickets are solved, they will be closed within an hour and control returned to the AI assistant.<br />
        ...
        <Frame><img src="/images/image-402.png" alt="" width="563"  /></Frame>
    2. If you want to immediately pass back control to the AI agent when a ticket has been solved, then you will need to set up a 'Trigger'. To do this, go to _**Objects and rules > Triggers > Create trigger.**_\
       \
...
<Frame><img src="/images/image-374.png" alt="" width="563"  /></Frame>

<Frame><img src="/images/image-375.png" alt="" width="563"  /></Frame>
...
<Frame><img src="/images/image-76-1.png" alt="" width="563"  /></Frame>
...
<Frame><img src="/images/image-372.png" alt="" width="500"  /></Frame>

2. Click the 3 dots next to the 'Connect' button, then select 'Uninstall':

<Frame><img src="/images/image-523.png" alt="" width="563"  /></Frame>

3. On the pop-up, click to confirm the Uninstall:

<Frame><img src="/images/image-383.png" alt="" width="442"  /></Frame>
