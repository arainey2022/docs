...
For a chat conversation in Intercom just reply to any open conversation as an admin/agent and the conversation's control will be taken from the AI agent, note, this will not work for email replies. 

For email replies in Intercom you will need to add a note saying "`Stop AI replies`" to the ticket.
