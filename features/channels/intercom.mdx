---
title: "Intercom"
description: "Connect your AI support agent to your Intercom workspace and existing Intercom live chat widget (Messenger) and email on your website with our Intercom app."
---
...
- You can add more knowledge to your AI agent in addition to your website and Intercom help center by using our [connections](/features/connections), live data or [file uploads](/features/file-uploads).
- [There are several ways your CS team can use your AI agent within Intercom](/features/channels/intercom#how-can-i-use-my-ai-chatbot-within-intercom), so you can use whichever works for them ([read on below for more](/features/channels/intercom#how-can-i-use-my-ai-chatbot-within-intercom)).
...
<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/qaLWmzJzLOs" title="Embedded video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
</Frame>
...
<Frame>
  <img
    src="/images/image-344.png"
    width="563"
  />
</Frame>

5. Your AskAI is now connected to Intercom and will be [providing "note" responses](/features/channels/intercom#how-to-draft-ai-conversational-replies-to-users-without-sending-them).
...
1. [_As a full conversational AI agent_](/features/channels/intercom#how-to-set-up-an-ai-powered-chatbot-within-intercom-fully-conversational-support)
2. [_As an internal tool for your support team to answer questions faster_](/features/channels/intercom#how-else-can-i-use-my-ai-powered-q-and-a-widget)
3. Default: [_As an agent tool to draft responses in notes, ready to send (or edit)_](/features/channels/intercom#how-to-draft-ai-conversational-replies-to-users-without-sending-them)

### How to set up an AI-powered support agent within Intercom (Fully conversational support)

1. [Connect your AI agent to Intercom](/features/channels/intercom#how-to-connect-your-ai-chatbot-to-intercom)
2. Toggle conversational replies "on" by going to your Dashboard then **_Channels \> Intercom_** clicking the "Direct replies" button beneath "Reply type".
3. That's it! Your Intercom messenger will now automatically respond to user queries using your AI agent's knowledge.

<Frame>
  <img
    src="https://downloads.intercomcdn.com/i/o/987939190/c785d586083ee92b2f11751b/chatbot.png"
    width="375"
  />
</Frame>
...
1. [Connect your AI support agent to Intercom](/features/channels/intercom#how-to-connect-your-ai-chatbot-to-intercom)
...
To assign a ticket or conversation to a specific human agent on escalation, [follow our guide here](/features/channels/intercom/human-escalation-workflows).
...
To trigger a workflow after a human escalation has taken place, [follow these instructions](/features/channels/intercom/human-escalation-workflows).
...
1. Turn off any email auto-replies or reply workflows for email within Intercom (**_Settings \> Channels \> Email \> Auto-replies_**)
2. Login to your My AskAI account
3. Go to **_Dashboard \> Channels \> Intercom \> Email replies_**
...
#### To take control of a conversation (chat and email) and stop the AI agent replying

For email and chat conversations in Intercom just reply to any open conversation as an admin/agent and the conversation's control will be taken from the AI agent.

<Info>
  For email replies in Intercom the sender must be different from the account used to send email replies (set within Dashboard \> Channels \> Intercom \> Email sender account)<br /><br />In general, set the sender as a team account or designated AI agent seat within Intercom.
...
1. Create a Macro (_Settings \> Workspace\> Macros (Saved replies)_) with the below message. The underlined text must be included. The remaining text can be customized. <br /><br />`"Hi there, I'll pass you back to our AI assistant for any further questions."`
...
1. [Connect your agent to Intercom](/features/channels/intercom#how-to-connect-your-ai-chatbot-to-intercom)
...
<Danger>
  This phrase must **_exactly_** match the pre-defined button you are going to use in your workflow message.
</Danger>
...
It will retain all the [same features of the Intercom agent](/features/channels/intercom#how-can-i-use-my-ai-chatbot-within-intercom), including human escalation, but within the respective platforms.
