---
title: "Intercom (Tagging)"
description: "Automatically tag your tickets and conversations in Intercom with custom tags and sentiment scores."
---
...
1. To set up your tags in Intercom, go to **AI Agent Setup \> AI Tagging** and click **Import conversation attribute.**
...
4. You will then see your tags auto-applied in Intercom. <br />If you feel any tags have been applied incorrectly, review the description for each tag to ensure it is clear.
...
To add a tag to your block list, go to **AI Agent Setup \> AI Tagging**, select the attribute that has the tag you want to block, then find the tag and click **Block.**
...
- If there are no [blocked tags or attributes](/features/channels/intercom/intercom-tagging#how-can-i-ensure-the-ai-agent-only-responds-to-certain-types-of-intercom-conversations-or-tickets) (i.e. AI is replying) then the conversation attribute is updated after 5 mins from first user message.
