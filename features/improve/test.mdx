---
title: "Test"
description: "We know putting an AI agent live with your customers can feel scary, so we want to give you the tools to boost your confidence. Test lets you see how your AI agent will perform on your questions."
---
...
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/dqAItfws6vg"
...
Our batch Test feature takes a sample of your historic support tickets and previous questions asked (if you have integrated [Zendesk](/features/channels/zendesk) or [Intercom](/features/channels/intercom)) and/or lets you add in your own test question set and shows you how your AI agent will respond to those questions, so you can see quickly how it will perform on day 1.
...
There are 3 ways you can add test questions to your AI agent to evaluate its performance:
...
<Frame><img src="/images/image-1-1-1-1.png" alt="" width="563"  /></Frame>

### How do I improve my AI agent responses once I have tested them?

Once you have tested your AI agent's responses, if you want to change or improve them you can add more [Knowledge](/features/connections), [Guidance](/features/improve/guidance) or a [Custom Answer](/features/improve/custom-answers).
...
You can change whether this happens automatically by applying [Handover & Escalation Guidance](/features/improve/guidance#handover-and-escalation).

When you see Answered in Test it shows whether the AI agent had sufficient knowledge added to it to answer the question.

You can add more knowledge to improve this via [Connections](/features/connections) or [Custom Answers](/features/improve/custom-answers).
...
To delete all of the Test questions and start again with a new Test question set, click the "Delete All" button on the main Test question set page, then follow the instructions to [add new Test questions](/features/improve/test#how-do-i-add-test-questions-to-my-ai-agent-to-evaluate-its-performance).
