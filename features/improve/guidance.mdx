---
title: "Guidance"
description: "Our guidance feature will help you set up your AI agent to respond exactly how you want it to, tone, scenarios and when you want it to escalate to your team."
---

<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/DZKtchoWgnA" title="Embedded video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
</Frame>
...
3. Select the [type of guidance](/features/improve/guidance#what-are-the-types-of-guidance-and-when-should-i-use-them) you want to add and click the "\+ New" button.
...
❌ _Before (unclear and open to interpretation):_

> _“Be professional but also friendly, keeping responses engaging.”_

#### ✅ _After (defined and actionable):_
...
❌ _Before (third-person and indirect)_
...
#### ✅ _After (direct and actionable)_
...
❌ _Before (tells AI customer support agent how to respond without an example):_

> "If a customer is frustrated, acknowledge their feelings and use calming language to show you care."

#### ✅ _After (helps AI customer support agent understand how it should and should not respond):_
...
When writing guidance there are a number of things you need to consider ([see here](/features/improve/guidance#how-do-i-write-the-best-guidance)). 
...
#### ❌ Taking actions (apart from human handover)
...
Guidance should be used to change the language e.g. "respond in Spanish" or "respond in the language you are spoken to in", for this you should use our [language feature](/features/languages-and-localization).

#### ❌ Adding information or knowledge content

You shouldn't give your AI agent knowledge snippets via guidance, these should be added via the [Knowledge](/features/connections) section of the dashboard or as [Custom Answers](/features/improve#how-do-i-create-a-custom-answer).

#### ❌ Instructing the AI agent to "not make things up"
...
#### ❌ Controlling where your AI agent will find answers from
...
<Info>
  Note that you can only create separate guidance for [Communication & Style](/features/improve/guidance#communication-style) guidance currently.
</Info>
...
<Info>
  This is an advanced form of using guidance, you may want to consider using [Tasks](/features/tasks) instead.
</Info>
...
Create a [Context & clarification](/features/improve/guidance#context-and-clarification) piece of guidance, for example:

> _When a user reports a bug, first ask for the following information before continuing troubleshooting: 1) what device are you using? 2) URL where the bug is occurring; 3) when was the bug first noticed._

Followed by a [Handover & escalation](/features/improve/guidance#handover-and-escalation) piece of guidance, for example:
