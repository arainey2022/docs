...
description: "Starter actions let users take quick actions, like booking a demo call, where you can define a specific webpage for them to open."
---

<Warning>
This feature is only available in the My AskAI widget, if you are using our [Intercom](/features/channels/intercom), [Zendesk](/features/channels/zendesk/zendesk-messaging) or [HubSpot](/features/channels/hubspot) integrations you will have to set up via workflows or chatflows within the respective platforms.
</Warning>
