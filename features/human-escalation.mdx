...
description: "Human escalation ensures customers can still talk to you when they need to. Best of all, we integrate with your existing live chat tools, so you won't have to learn to use a new one."
---
...
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/RaW1XIrfR38"
...
* Learn more about [Intercom](/features/channels/intercom#how-does-human-handover-work-when-using-the-intercom-messenger-integration) escalation
* Learn more about [Zendesk](/features/channels/zendesk) (messaging and tickets) escalation
* Learn more about [Freshchat](/features/channels/freshchat) escalation
* Learn more about [Freshdesk](/features/channels/freshdesk) escalation
* Learn more about [HubSpot](/features/channels/hubspot) escalation
* Learn more about [Gorgias](/features/channels/gorgias#how-does-human-handover-work-when-using-the-gorgias-integration-for-email-tickets) escalation
...
* [Zendesk](/features/channels/zendesk) (Messenger and Tickets)
* [HubSpot](/features/channels/hubspot)
* [Freshchat](/features/channels/freshchat) by Freshworks
...
4. You can define qualitative rules or scenarios for the AI to look out for to handover the conversation, using [guidance](/features/improve/guidance#handover-and-escalation), e.g. "If the user contacts us about a safety issue, handover to a person"
5. If you are using one of our tagging integrations e.g. [Zendesk](/features/channels/zendesk/zendesk-tagging) or [Intercom](/features/channels/intercom/intercom-tagging), you can specify topics that you don't want your AI to answer on, and you want an instant handover to occur.
