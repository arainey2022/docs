---
title: "User Data API setup"
description: "How to set up your AI agent to use user data ingested via API to improve its responses."
---

<Info>
If you have a Shopify store, you can use our [no-code Shopify connector](/features/shopify)
</Info>
...
1. Login to your Dashboard and go to **Knowledge > Content**&#x20;
2. Scroll to **Connect live user data** and click the button that says **+ New Connection**
