...
1. Give it a descriptive name and description, e.g.:<br /><br />**Name**: Pre-Escalation User Info Collection<br /><br />**Description:** Collect the customer's email and phone number before passing them on or ending the interaction.
2. Turn the toggle on for "Run task on every escalation / handover (live chat only)<br /><img src="/images/image-549.png" /><br />
