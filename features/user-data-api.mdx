...
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/uG5I4g8LqRU"
...
Or, if you have a **Shopify store**, you can connect it using our [Shopify connector](/features/shopify).

To set this up, follow the instructions [here](/features/user-data-api/user-data-api-setup).
...
Yes, your AI agent can take API actions automatically, it will do this using a slightly different process, you can read more about it here: [AI Actions (Tools)](/features/ai-actions-tools).
...
[Check your integration is supported](/features/user-data-api#which-integrations-can-i-use-the-user-data-api-with) before contacting our live chat support as only some integrations are currently supported.
