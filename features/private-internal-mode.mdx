...
<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/jMK6gYAaBZ0" title="Embedded video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
</Frame>
...
1. Go to **_Knowledge \> Content \> Upload files_**
2. Click "**Manage**"
...
1. Go to **_Knowledge \> Content \> Connect knowledge sources \>_ Connected knowledge sources**
2. Click "**Manage**"
