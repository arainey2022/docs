---
title: "Task End-to-End Examples"
description: "Full examples of some tasks, so you can see what they look like once added to your AI Agent."
---

This guide walks you through creating your first [Task](/features/tasks) in My AskAI — whether your task uses [Tools (APIs)](/features/ai-actions-tools) or runs without them.&#x20;
...
If your task uses [tools (APIs)](/features/tasks/task-end-to-end-examples#step-6-add-available-tools-optional), include the tool reference here:
