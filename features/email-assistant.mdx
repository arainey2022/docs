...
description: "Your email assistant will use your AI assistant's knowledge to automatically respond to your support emails on your behalf, users can still contact a human if it can't answer."
hidden: true
---

<Frame><img src="/images/image-169.png" alt=""  /></Frame>
...
* [How do I test my AI email assistant?](/features/email-assistant#how-can-i-test-my-ai-email-assistants-responses)
* [How do I verify my email for my AI email assistant?](/features/email-assistant#verifying-your-ai-email-assistants-email)
* [Setting up your AI email assistant - Manual assist mode](/features/email-assistant#manual-assist-1)
* [Setting up your AI email assistant - Autopilot mode](/features/email-assistant#autopilot-1)
* [How to set up email forwarding](/features/email-assistant#how-do-i-set-up-email-forwarding-with-my-email-provider)
...
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/WG3-qUpZL9s"
...
You can have your AI email assistant [auto-respond to things for you](/features/email-assistant#autopilot), or [you can choose which questions you want it to answer by manually forwarding emails yourself](/features/email-assistant#manual-assist).
...
<Frame><img src="/images/image-170.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-466.png" alt=""  /></Frame>

2. Scroll through the carousel and click _"Setup AI email assistant"_&#x20;

<Frame><img src="/images/image-137.png" alt=""  /></Frame>
...
3.  (Optional) You can start by trying out your email assistant by clicking "Test your email assistant" and then choosing to either:
    ...
    * Forward an email to your assistant — this lets' you copy your assistant's custom email address, which you can then paste and use to forward a real customer support email (it won't reply to the customer during setup!)
    ...
    <Frame caption="Trying out your AI email assistant"><img src="/images/image-138.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-151.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-139.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-142.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-143.png" alt=""  /></Frame>

8. At this stage you will have to decide [which mode](/features/email-assistant#which-mode-should-i-use-for-my-ai-email-assistant) to use your AI email assistant:
   * [Manual Assist](/features/email-assistant#manual-assist) OR
   * [Autopilot](/features/email-assistant#autopilot)
...
<Frame><img src="/images/image-146.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-147.png" alt=""  /></Frame>

<Frame><img src="/images/image-148.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-465.png" alt=""  /></Frame>

#### Autopilot

1. Choose your email assistant's mode, in this case, "Autopilot" ([want to use manual assist?](/features/email-assistant#manual-assist-1)):

<Frame><img src="/images/image-154.png" alt=""  /></Frame>

2. Set up a forwarding rule from your existing support inbox (e.g. support@company.com) to your AI email assistant's email (in the box that says "Forwarding rule to" with your mail provider. You can see how to do this for [Gmail here](/features/email-assistant#setting-up-email-forwarding-for-gmail) and [Outlook here](/features/email-assistant#setting-up-email-forwarding-for-outlook).

<Frame><img src="/images/image-155.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-167.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-168.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-138.png" alt=""  /></Frame>

Once you have sent the email, wait (up to 30 seconds) while your AI assistant receives your email, and then you will see it shown below the 2 buttons, along with an answer generated by your AI assistant based on the knowledge you have uploaded.

<Frame><img src="/images/image-152.png" alt=""  /></Frame>
...
<Info>
This is only necessary when your AI email assistant is in ["Autopilot" mode](/features/email-assistant#autopilot).
</Info>
...
<Frame><img src="/images/image-156.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-158.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-159.png" alt=""  /></Frame>

7. Once verified you should see a confirmation that the forwarding address has been added.

<Frame><img src="/images/image-160.png" alt=""  /></Frame>

<Frame><img src="/images/image-161.png" alt=""  /></Frame>
...
8. You have now created a forwarding address. But no email will be automatically forwarded until you either:
   1.  Choose to "Forward a copy of all incoming mail to \<your new forwarding address>" from the Forwarding and POPMAP settings<br />
       ...
       <Frame><img src="/images/image-134.png" alt=""  /></Frame>
   2. You [create a filter rule to decide which mail is forwarded](/features/email-assistant#setting-up-email-filtering-for-gmail)
...
<Frame><img src="/images/image-162.png" alt=""  /></Frame>

<Frame><img src="/images/image-163.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-164.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-166.png" alt=""  /></Frame>
...
<Frame><img src="/images/image-116.png" alt=""  /></Frame>
...
<Frame><img src="/images/untitled-26.png" alt=""  /></Frame>
