...
### Are unpublished or private Zendesk help articles added to my AI agent?

No, by default private and unpublished articles are not used by your AI agent. You will see in your Zendesk help article connection that these are automatically marked as '[Private](https://support.myaskai.com/features/private-internal-mode)', however you can give your AI agent access to them, by toggling them to be 'Public' (this will only make the article visible to the AI agent, it won't make the Zendesk article itself visible).
