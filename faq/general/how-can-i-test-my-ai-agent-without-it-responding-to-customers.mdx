...
2. If you don't even want to connect your AI to your existing support platform yet, you can install our [**Chrome Extension**](/features/channels/chrome-extension), this will then only work in your browser, not anyone else in your team, so you can see again how it works and what answers it gives before going to the next stage.
