...
In Zendesk you can use our [Ticket tagging](/features/channels/zendesk/zendesk-tagging) feature in combination with Zendesk triggers to route conversations to either your AI agent or human agents. This will allow you to have more control over which tickets your AI agent is handling.
